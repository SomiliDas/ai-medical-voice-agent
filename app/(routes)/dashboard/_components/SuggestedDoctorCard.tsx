...
function SuggestedDoctorCard({doctorAgent, setSelectedDoctor} : props) {
  return (
    <div className='flex flex-col items-center gap-1 p-4 border rounded-2xl shadow cursor-pointer hover:border-blue-500' onClick={()=>setSelectedDoctor(doctorAgent)}>
